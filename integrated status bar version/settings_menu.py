...
class OthelloSettingsGUI:
    ...
    def __init__(self):
        ...
        self._root = Tk()
        self._root.title('Othello Setup')
    ...
    def _gridall(self):
        """grids each child widget of self._root."""
    ...
    def _buildall(self):
        ...
        self._start_button = Button(self._root, text='Start Othello',
                              command=self._start,
                              width=15, height=7)
        self._gridall()
    ...
    def _buildsliders(self):
        """self explanatory"""
        # rows
        self._rows_var = IntVar()
        self._row_scale = Scale(self._root, variable=self._rows_var,
        ...
        self._columns_scale = Scale(self._root, variable=self._columns_var,
                              from_=16, to=4, length=200,
                              resolution=2, tickinterval=2,
                              showvalue=0)
    ...
    def _buildfirstplayeroptions(self):
        """self explanatory"""
        self._firstplayer_var = StringVar()
        self._firstplayeroption_frame = Frame(self._root)
    ...
    def _buildtopleftoptions(self):
        """self explanatory"""
        self._topleftoption_var = StringVar()
        self._topleftoption_frame = Frame(self._root)
    ...
    def _buildinversemodeoptions(self):
        """self explanatory"""
        self._inversemode_var = StringVar()
        self._inversemode_frame = Frame(self._root)
    ...
    def _buildlabels(self):
        """self explanatory"""
        self._rows_label = Label(self._root, text='Rows')
        self._columns_label = Label(self._root, text='Columns')
        self._firstplayer_label = Label(self._root, text='First turn')
        self._topleftpiece_label = Label(self._root, text='Top left piece')
        self._inversemode_label = Label(self._root,
