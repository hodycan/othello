...
class OthelloGame:
    ...
    def trymove(self, row, column) -> None:
        """
    ...
    def _scanline(self, piece, row, column, r_delta, c_delta) -> list:
        """
    ...
    def _applymove(self, piece: str, row: int,
                   column: int, all_pieces_to_flip: list) -> None:
        """
        ...
        if self._has_valid_moves(self._opposite(self.turn)):
            ...
            raise NoMovesForNextTurn
        else:
            self.gameover = True

    
    def _nextturn(self) -> None:
        """Changes whose turn it is in the game."""
        self.turn = self._opposite(self.turn)


    def _recount_scores(self) -> None:
    ...
    def _playerpiece(self, player) -> str:
        """
    ...
    def _findAImove(self, turn, row, column) -> tuple:
    ...
    def _pieceplayer(self, piece) -> str:
...
class NoMovesForNextTurn(Exception):
    """"""
    pass
